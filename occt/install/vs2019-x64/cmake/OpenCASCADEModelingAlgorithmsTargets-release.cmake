...
list(APPEND _cmake_import_check_files_for_TKGeomAlgo "${_IMPORT_PREFIX}/win64/vc14/lib/TKGeomAlgo.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKGeomAlgo.dll" )
...
list(APPEND _cmake_import_check_files_for_TKTopAlgo "${_IMPORT_PREFIX}/win64/vc14/lib/TKTopAlgo.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKTopAlgo.dll" )
...
list(APPEND _cmake_import_check_files_for_TKPrim "${_IMPORT_PREFIX}/win64/vc14/lib/TKPrim.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKPrim.dll" )
...
list(APPEND _cmake_import_check_files_for_TKBO "${_IMPORT_PREFIX}/win64/vc14/lib/TKBO.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKBO.dll" )
...
list(APPEND _cmake_import_check_files_for_TKShHealing "${_IMPORT_PREFIX}/win64/vc14/lib/TKShHealing.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKShHealing.dll" )
...
list(APPEND _cmake_import_check_files_for_TKBool "${_IMPORT_PREFIX}/win64/vc14/lib/TKBool.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKBool.dll" )
...
list(APPEND _cmake_import_check_files_for_TKHLR "${_IMPORT_PREFIX}/win64/vc14/lib/TKHLR.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKHLR.dll" )
...
set_target_properties(TKHelix PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/win64/vc14/lib/TKHelix.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/win64/vc14/bin/TKHelix.dll"
  )

list(APPEND _cmake_import_check_targets TKHelix )
list(APPEND _cmake_import_check_files_for_TKHelix "${_IMPORT_PREFIX}/win64/vc14/lib/TKHelix.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKHelix.dll" )
...
list(APPEND _cmake_import_check_files_for_TKFillet "${_IMPORT_PREFIX}/win64/vc14/lib/TKFillet.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKFillet.dll" )
...
list(APPEND _cmake_import_check_files_for_TKOffset "${_IMPORT_PREFIX}/win64/vc14/lib/TKOffset.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKOffset.dll" )
...
list(APPEND _cmake_import_check_files_for_TKFeat "${_IMPORT_PREFIX}/win64/vc14/lib/TKFeat.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKFeat.dll" )
...
list(APPEND _cmake_import_check_files_for_TKMesh "${_IMPORT_PREFIX}/win64/vc14/lib/TKMesh.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKMesh.dll" )
...
list(APPEND _cmake_import_check_files_for_TKXMesh "${_IMPORT_PREFIX}/win64/vc14/lib/TKXMesh.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKXMesh.dll" )
